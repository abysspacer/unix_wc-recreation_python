import argparse
from file_details import get_byte_count, get_line_count
...
details = [args.lines and get_line_count(args.file_path), args.bytes and get_byte_count(args.file_path), args.file_path]
